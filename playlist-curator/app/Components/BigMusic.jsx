export default function BigMusic({ songData, trackId = "0a4MMyCrzT0En247IhqZbD" }) {
    ...
    return (
      <div className="flex flex-col items-center justify-center h-full bg-black text-white p-2 hover:bg-gray-900 transition duration-300">
        <a href={spotifyUrl} target="_blank" rel="noopener noreferrer" className="p-4">
        {/* Big Image */}
        <img 
        ...
        <div className="text-center mb-5">
          <div className="text-2xl font-bold">{firstSong.songName || "Unknown Song"}</div>
          <div className="text-lg text-gray-400">{firstSong.artist || "Unknown Artist"}</div>
        </div>
