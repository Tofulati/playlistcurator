    ...
    return (
        <div className="flex items-center hover:bg-gray-800 transition duration-30 p-2 rounded justify-between">
            <div className="flex items-center">
                <span className="text-gray-700 font-semibold text-3xl w-4">{number}</span>
                <img
                    src={pfp}
                    alt={name}
                ...
                <div style={{ width: '250px' }}>
                    {name ? (
                        <div className="text-gray-200 font-semibold mb-2 text-xl">{name}</div> // Increased font size
                    ) : (
