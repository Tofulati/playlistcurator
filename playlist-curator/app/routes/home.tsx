      ...
      <div className="bg-wblackhite">
        <main className="isolate">
          <div className="relative isolate -z-10">
            <svg className="absolute inset-x-0 top-0 -z-10 h-[64rem] w-full stroke-gray-200 [mask-image:radial-gradient(32rem_32rem_at_center,black,transparent)]" aria-hidden="true">
              <defs>
...
>
              ...
              <div className="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
                <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                  <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                    <h1 className="text-4xl font-bold tracking-tight text-[#1ed760] sm:text-6xl">Find the Best Music for You</h1>
                    <p className="relative mt-6 text-lg leading-8 text-green-500 sm:max-w-md lg:max-w-none">At Playlist Curator, we believe that every song tells a story, and every story has an audience. Through advanced artificial intelligence, we're not just curating playlists; we're orchestrating symphonies of connections.</p>
                  </div>
          ...
          <div className="mx-auto -mt-12 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:-mt-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
              <h2 className="text-3xl font-bold tracking-tight text-[#1ed760] sm:text-4xl">How it Works</h2>
              <div className="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
                <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                  <p className="text-xl leading-8 text-green-500">Upon joining Playlist Curator, users are prompted to share their personal playlists. Our state-of-the-art AI backend initiates an intricate process called 'Musical DNA Analysis'. Just as human DNA consists of sequences that determine our unique characteristics, each song has its own 'musical DNA' — a combination of rhythms, melodies, harmonies, lyrics, and more. Our system breaks down each song into its elemental components, creating a detailed profile that goes beyond just genre or artist.</p>
                  <div className="mt-10 max-w-xl text-base leading-7 text-green-500">
                    <p>With the musical DNA extracted, our sophisticated Neural Network commences its training phase. Utilizing millions of data points from the playlists, the system identifies patterns and similarities among users. It then categorizes users into specific 'User Clusters'. These clusters aren’t just based on common song choices, but on the underlying musical elements that users seem to gravitate towards. This ensures that even if two users have never heard the same song, they can still be matched based on shared musical sensibilities.</p>
                    <p className="mt-10">When a user introduces a new song, Playlist Curator gets to work immediately. The song undergoes a rapid Musical DNA Analysis and is then run through our trained Neural Network. The system determines which User Cluster(s) the song would most resonate with, allowing for highly accurate and tailored recommendations. This means that when you share a new favorite track, our platform knows exactly who in your circle will appreciate it most, creating an environment of shared discovery and joy.</p>
                  </div>
                </div>
                <div className="lg:flex lg:flex-auto lg:justify-center">
                  <dl className="w-64 space-y-8 xl:w-80">
                    <div className="flex flex-col-reverse gap-y-4">
                      <dt className="text-base leading-7 text-[#1ed760]">Total Users</dt>
                      <dd className="text-5xl font-semibold tracking-tight text-green-500">4</dd>
                    </div>
                    <div className="flex flex-col-reverse gap-y-4">
                      <dt className="text-base leading-7 text-[#1ed760]">Assets under holding</dt>
                      <dd className="text-5xl font-semibold tracking-tight text-green-500">$19</dd>
                    </div>
                    <div className="flex flex-col-reverse gap-y-4">
                      <dt className="text-base leading-7 text-[#1ed760]">New users annually</dt>
                      <dd className="text-5xl font-semibold tracking-tight text-green-500">0.1</dd>
                    </div>
                  </dl>
                </div>
              </div>
